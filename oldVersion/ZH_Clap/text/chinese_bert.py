...
def get_bert_feature(
    ...
    if device not in models.keys():
        #print("\n\nfp16\n\n")
        models[device] = MegatronBertModel.from_pretrained(pretrained_model_name_or_path=LOCAL_PATH).to(device)#,torch_dtype=torch.float16
    with torch.no_grad():
    ...
    return phone_level_feature.T#.type(torch.cuda.Floattensor)
